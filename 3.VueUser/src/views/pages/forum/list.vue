<template>
	<div class="app-contain" :style='{"width":"86%","padding":"10px 20px","margin":"30px auto 50px","position":"relative","borderRadius":"0px","background":"none"}'>
...
<style lang="scss" scoped>
	...
	.forum_comment_box {
		...
		.comment_add_box {
			...
			// 按钮-悬浮
			.comment_add:hover {
				transform: rotate(0deg) scale(0.9) skew(0deg, 0deg) translate3d(0px, -3px, 0px);
			}
		}
		//帖子评论
		.forum_comment_list {
