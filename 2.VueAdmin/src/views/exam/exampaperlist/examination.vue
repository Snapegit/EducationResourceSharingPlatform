	...
	.question_list {
		...
		.question {
			...
			.questionTitle {
				...
				// 单选题
				:deep(.el-tag--success) {
					background-color: #f0f9eb10;
					color: #67c23a;
					border-color: #e1f3d830;
				}
				// 判断题
				:deep(.el-tag--danger) {
					background-color: #fef0f010;
					color: #f56c6c;
					border-color: #fde2e230;
				}
				// 填空题
				:deep(.el-tag--info) {
					background-color: #f4f4f510;
					color: #909399;
					border-color: #e9e9eb30;
				}
				// 多选题
				:deep(.el-tag--warning) {
					background-color: #fdf6ec10;
					color: #e6a23c;
					border-color: #faecd830;
				}
			}
			// 选项列表
			.optionList {
